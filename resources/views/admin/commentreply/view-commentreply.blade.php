                ...
                <div class="page-header float-right" >
                    <div class="page-title" >
                        <ol class="breadcrumb text-right" >
                            ...
                            <li><a href="{{ route('admin.comment.reply.list') }}">Comment Reply</a></li>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer" style="background:#605ca8;color: #fff">
                                ...
                                <button type="button" class="btn btn-warning" onclick="event.preventDefault();
                                 ...
                                 <form action="{{ route('admin.comment.reply.delete',$comment->id) }}" style="display:none" id="deleteComment-{{ $comment->id }}"></form>
                            </div>
                        </div>
                    </div>
                </div>
