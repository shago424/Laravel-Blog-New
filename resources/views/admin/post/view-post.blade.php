                                ...
                                <strong class="card-title">Post List
                                    <button type="button" class="btn btn-warning btn-sm float-right" data-toggle="modal" data-target="#addpost">
                                     <i class="fa fa-plus-circle"></i> Add Post 
                                       ...
                                       <a style="margin-right: 10px;" style="padding-right: 5px" href="{{ route('post.create') }}" class="btn btn-danger btn-sm float-right" >
                                                    <i class="fa fa-plus-circle"></i> Add Post
                                     </a>
                                </strong>
                            </div>
                                        ...
                                        <tr>
                                           ...
                                           @if($post->status == 1)
                                            ...
                                            <td class="text-center">
                                                 @if($post->status == 1)
                                            <a href="{{ route('post.inactive',$post->id) }}" class="btn btn-sm btn-warning"><i class="fa fa-arrow-down"></i></a>
                                            @else
                                             <a href="{{ route('post.active',$post->id) }}" class="btn btn-sm btn-success"><i class="fa fa-arrow-up"></i></a>
                                            @endif
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                    ...
                                    <div class="card-body card-block" >
                                        <form action="{{ route('post.store') }}" method="post" class="form-horizontal" id="addPost" enctype="multipart/form-data">
                                            @csrf
                                            {{-- @method('put') --}}
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer" style="background:#605ca8;color: #fff">
                                ...
                                <button type="button" class="btn btn-warning" onclick="event.preventDefault();
                                 ...
                                 <form action="{{ route('post.delete',$post->id) }}" style="display:none" id="deletePost-{{ $post->id }}"></form>
                            </div>
                        </div>
                    </div>
                </div>
