...
@section('content')
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2 style="color:white"><i class="fa fa-leaf bg-green"></i> Category by: Gardening</h2>
                    </div><!-- end col -->
                    <div class="col-lg-4 col-md-4 col-sm-12 hidden-xs-down hidden-sm-down">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item" style="font-size:20px"><a style="color:#fff" href="#">Home</a></li>
                            <li class="breadcrumb-item" style="font-size:20px"><a style="color:#fff" href="#">Blog</a></li>
                            <li style="font-size:20px;color:black" class="breadcrumb-item active">Gardening</li>
                        </ol>
                    </div><!-- end col -->                    
                </div><!-- end row -->
            </div><!-- end container -->
 ...
 <section class="section wb">
            ...
            @else
                                 @foreach($categoryIdByPosts as $post)
