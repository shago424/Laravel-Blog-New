            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-5 col-md-6 col-sm-6 hidden-xs-down">
                        <div class="topsocial">
                            <a target="_blank" href="http://www.facebook.com/sagors1" data-toggle="tooltip" data-placement="bottom" title="Facebook"><i class="fa fa-facebook"></i></a>
                            <a target="_blank" href="http://www.youtube.com/shagor424" data-toggle="tooltip" data-placement="bottom" title="Youtube"><i class="fa fa-youtube"></i></a>
                            {{-- <a target="_blank" href="#" data-toggle="tooltip" data-placement="bottom" title="Pinterest"><i class="fa fa-pinterest"></i></a> --}}
                            <a target="_blank" href="http://www.twitter.com/shagor424" data-toggle="tooltip" data-placement="bottom" title="Twitter"><i class="fa fa-twitter"></i></a>
                            <a target="_blank" href="http://www.instagram.com/shagor424" data-toggle="tooltip" data-placement="bottom" title="Instagram"><i class="fa fa-instagram"></i></a>
                            <a target="_blank" href="http://www.ssbfreelancer.com" data-toggle="tooltip" data-placement="bottom" title="Website"><i class="fa fa-internet-explorer"></i></a>
